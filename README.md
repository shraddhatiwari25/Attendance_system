...
3. Finally run the [streamlit_local_app_bussines_ready.py]
...
7. [streamlit_test_app_online.py]: very similar file to the previous script but without the **Live Attendance Feature** and it works online right from this .
